...
/// <summary>
/// Policy Studio evaluator tests — ported unchanged from RuleForge.Admin. The
/// <see cref="TestRunner"/> is self-contained (no engine dependency), so these
/// assert its verdict semantics directly.
/// </summary>
public class PolicyStudioTestRunnerTests
{
